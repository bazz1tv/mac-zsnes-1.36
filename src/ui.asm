...
.nofpsatstart
	...
	mov eax,outofmemory
    ; BAZZ here, I am taking out this memory alignment test
    ; it bitches a lot, the ALIGN 32 doesn't seem to help.. 
    ; the thing changes as teh code changes.. so I'm just commenting it out.
	test eax,3h
	jnz .failalign
...
ALIGN32
; little hack here to stop zsnes from bitching about misaligned code
; use 3 bytes for production code, 2 for debug...
%ifdef DEBUG
db 1,2
%else
db 1,2, 3, 4
